...
func (c *productServiceClient) CreateProduct(ctx context.Context, in *Product, opts ...grpc.CallOption) (*Product, error) {
	out := new(Product)
	err := c.cc.Invoke(ctx, "/github.com.PauloLopesEstevao.webserverexamplego.ProductService/CreateProduct", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ProductService_CreateProduct_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/github.com.PauloLopesEstevao.webserverexamplego.ProductService/CreateProduct",
	}
...
var ProductService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "github.com.PauloLopesEstevao.webserverexamplego.ProductService",
